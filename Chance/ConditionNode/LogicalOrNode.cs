...
/// </summary>
[GlobalClass]
public partial class LogicalOrNode : ContainerConditionNode, IConditionNodeDeserializer<LogicalOrNode>
{
    /// <summary>
    /// 定义JSON序列化的子节点容器键名
    /// </summary>
    ...
    public LogicalOrNode(Godot.Collections.Array<ConditionNode> children)
    {
        Children = children;
    }
