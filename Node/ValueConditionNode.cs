...
namespace LogicTree
{
    ...
    /// </summary>
    public class ValueConditionNode: LeafConditionNode<double>, IConditionNodeDeserializer<ValueConditionNode>
    {
        ...
        /// 初始化数值条件
        /// </summary>
        /// <param name="conditionName">数值条件字符串</param>
        /// <param name="expectedValue">期望的阈值</param>
        public ValueConditionNode(string conditionName, double expectedValue)
        {
        ...
        /// <param name="expectedValue">期望的阈值</param>
        public ValueConditionNode(Enum conditionName, double expectedValue)
        {
            ConditionName = conditionName.ToSnakeCase();
            Value = expectedValue;
        }
        ...
        [NodeDeserializer(JTokenType.Integer)]
        [NodeDeserializer(JTokenType.Float)]
